...
export default function CartSubtotal({ totalItems, totalPrice, onProceedToBuy }: CartSubtotalProps) {
  return (
    <div className="bg-white p-6 flex flex-col md:flex-row items-center justify-between border-t border-gray-100 md:border-t-0 md:rounded-xl shadow-sm">
      ...
      <button
        ...
        className="w-full md:w-auto px-8 py-3 bg-yellow-400 hover:bg-yellow-500 text-gray-900 text-sm font-bold rounded-full transition-colors focus:ring-2 focus:ring-yellow-300 outline-none"
      >
        Proceed to buy
      </button>
    </div>
